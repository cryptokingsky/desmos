...
type MsgCreatePost struct {
	...
	AllowsComments bool         `protobuf:"varint,3,opt,name=allows_comments,json=allowsComments,proto3" json:"allows_comments,omitempty" yaml:"allows_comments"`
	Subspace       string       `protobuf:"bytes,4,opt,name=subspace,proto3" json:"subspace,omitempty" yaml:"subspace"`
	OptionalData   OptionalData `protobuf:"bytes,5,rep,name=optional_data,json=optionalData,proto3,castrepeated=OptionalData" json:"optional_data" yaml"optional_data,omitempty"`
	Creator        string       `protobuf:"bytes,6,opt,name=creator,proto3" json:"creator,omitempty" yaml:"creator"`
	Attachments    []Attachment `protobuf:"bytes,7,rep,name=attachments,proto3" json:"attachments" yaml"attachments,omitempty"`
...
type MsgEditPost struct {
	...
	Message     string       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty" yaml:"message"`
	Attachments []Attachment `protobuf:"bytes,3,rep,name=attachments,proto3" json:"attachments" yaml"attachments,omitempty"`
...
type MsgAnswerPoll struct {
	PostID      string   `protobuf:"bytes,1,opt,name=post_id,json=postId,proto3" json:"post_id,omitempty" yaml:"post_id"`
	UserAnswers []string `protobuf:"bytes,2,rep,name=user_answers,json=userAnswers,proto3" json:"user_answers,omitempty" yaml:"answers"`
...
var fileDescriptor_12fe981997856c11 = []byte{
	...
	,
}
